...
byte Osciloscopio[4] = {0x90, 0x0E, 0xE4, 0xA4} ;
byte EstacionSoldado[4] = {0x06, 0x76, 0x25, 0xD9} ;
byte Soldador[4] = {0x06, 0x76, 0x25, 0xD9} ;
byte Estano[4] = {0x06, 0x76, 0x25, 0xD9} ;
byte Flux[4] = {0x06, 0x76, 0x25, 0xD9} ;
...
void Transmitir(){
  vw_send((uint8_t *)Profesor, strlen(Profesor));
  vw_wait_tx();
  vw_send((uint8_t *)Herramienta, strlen(Herramienta));
  vw_wait_tx();
  vw_send((uint8_t *)Evento, strlen(Evento));
  vw_wait_tx();
